...
export const Columns: ColumnDef<UptimeEvent>[] = [
    ...
    },
    {
        ...
        header: 'Status',
        cell: ({ row }) =>
            row.original.isUp ? <Badge variant="success">Up</Badge> : <Badge variant="destructive">Down</Badge>,
    },
    {
        accessorKey: 'isFalsePositive',
        header: 'False Positive',
        cell: ({ row }) =>
            row.original.isFalsePositive ? <Badge variant="warning">Yes</Badge> : <Badge variant="secondary">No</Badge>,
    },
    {
        accessorKey: 'note',
        header: 'Note',
